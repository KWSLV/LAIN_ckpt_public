...
# 08: Rank-controlled version of the paper V5 formula. Text Adapter is off.
export EXPERIMENT_ID="08"
export EXPERIMENT_NAME="uo_paper_gate_rank64"
export EXPERIMENT_DESCRIPTION="UO paper-formula low-rank SceneGate rank=64"
