...
echo "[$SCRIPT_NAME] Inherit: LAIN backbone and Object adapter tensors from checkpoint"
echo "[$SCRIPT_NAME] Text: OFF"
echo "[$SCRIPT_NAME] SceneGate: OFF"
echo "[$SCRIPT_NAME] Object: rank=4, inherited from checkpoint, the only trainable module"
...
WANDB_RUN_GROUP="A4_ep9_module_inherit" \
