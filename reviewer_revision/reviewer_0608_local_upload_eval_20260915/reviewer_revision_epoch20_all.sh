...
run_if_selected() {
  local id="$1"
  if [[ -n "$EVAL_IDS" && " $EVAL_IDS " != *" $id "* ]]; then
    return 0
  fi
  run_eval "$@"
}
...
run_if_selected 01 01_uo_joint_gate_lr1e4_seed66 unseen_object 36 1 last joint_lr1e4
run_if_selected 02 02_uo_joint_gate_lr3e4_seed66 unseen_object 36 1 last joint_lr3e4
run_if_selected 03 03_uo_joint_gate_alpha002_seed66 unseen_object 36 1 last joint_alpha002
run_if_selected 04 04_uo_joint_gate_alpha005_seed66 unseen_object 36 1 last joint_alpha005
run_if_selected 05 05_uo_joint_gate_start5_seed66 unseen_object 36 1 last joint_start5
run_if_selected 06 06_uo_text_rank8_seed66 unseen_object 36 1 last text_rank8
run_if_selected 07 07_uo_paper_gate_rank32_seed66 unseen_object 36 1 all gate_rank32
run_if_selected 08 08_uo_paper_gate_rank64_seed66 unseen_object 36 1 all gate_rank64
run_if_selected 09 09_uo_paper_gate_no_centering_seed66 unseen_object 36 1 all gate_no_centering
run_if_selected 10 10_rfuc_lain_matched_seed66 rare_first 24 1 all baseline
run_if_selected 11 11_rfuc_text_rank4_seed66 rare_first 24 1 all text_rank4
run_if_selected 12 12_nfuc_lain_matched_seed66 non_rare_first 36 1 all baseline
run_if_selected 13 13_nfuc_text_rank4_seed66 non_rare_first 36 1 all text_rank4
run_if_selected 14 14_uv_lain_matched_seed66 unseen_verb 36 0 all baseline
run_if_selected 15 15_uv_text_rank4_seed66 unseen_verb 36 0 all text_rank4
