...
class CustomisedDLE(DistributedLearningEngine):
            ...
            while True:
                ...
                if self._rank == 0:
                    print(
                        ...
                        f'{logical_epoch}/{n}, attempt={retry_count + 1}, '
    ...
    def _initialise_staged_retry_policy(self):
        if self._staged_policy_ready:
            return
        self._staged_initial_lrs = self._staged_group_lrs()
        ...
        if self._rank == 0:
            print(
                '[Staged Retry] Fixed LR scheduler disabled; initial LRs: '
