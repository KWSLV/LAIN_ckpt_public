...
SESSION_NAME="${SESSION_NAME:-lain_ours_joint_$TIMESTAMP}"
...
TRAIN_COMMAND="cd '$ROOT' && RUN_ROOT='$RUN_ROOT' OUTPUT_DIR='$OUTPUT_DIR' bash scripts/training/UO_ours_joint.sh 2>&1 | tee -a '$LOG_FILE'"
...
echo "[INFO] Full Ours training started: $SESSION_NAME"
