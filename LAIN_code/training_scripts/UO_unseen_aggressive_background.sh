...
SESSION_NAME="${SESSION_NAME:-lain_uo_aggressive_$TIMESTAMP}"
...
TRAIN_COMMAND="cd '$ROOT' && RUN_ROOT='$RUN_ROOT' OUTPUT_DIR='$CHECKPOINT_DIR' bash scripts/training/UO_unseen_aggressive.sh 2>&1 | tee -a '$LOG_FILE'"
